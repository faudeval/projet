    ...
    public class Obj
    {
        ...
        public virtual void Update(GameTime gameTime)
        {
            if (IsActive && IsReady)
            {
                ...
                if (Position.X > GameplayScreen.game.Window.ClientBounds.Width || Position.Y > GameplayScreen.game.Window.ClientBounds.Height || Position.X < 0 || Position.Y < 0)
                    IsActive = false;
            }
        }
        ...
        {
            if (IsActive && IsReady)
                GameplayScreen.spriteBatch.Draw(Image, Position, Color.White);
        }
        #endregion
    }
}
